...
DB2 = DB[DB$method!='PL' & !is.na(DB$g_calc),] #keep only the behavioral studies, remove outliers and NAs.
...
forest.rma(simple_model, annotate = FALSE, xlim = c(-13,3), ylim = c(-1,51),
...
basic perceptual abilities are present at birth and become increasingly differentiated and refined over age Turati 2004. Filters, potentially corresponding to neurons response profiles (Moore & Woolley, 2019).
