...
DB$test_lang<-factor(DB$test_lang)
...
#base model 
base_model <-rma.mv(g_calc, g_var_calc, mods = response_mode, random = ~ 1 | study_ID/same_infant, data=DB, weighted=TRUE, method = "ML", subset=!DB$outlier)

#full model
full_model <-rma.mv(g_calc, g_var_calc, mods=~ naturalness*agec*test_lang, random = ~ 1 | study_ID/same_infant, data=DB, weighted=TRUE, method = "ML", subset=!DB$outlier)
