...
DB$response_mode<-factor(DB$response_mode)
...
contrasts(DB$response_mode) = contr.sum(3)
...
contrasts(DB$test_lang) <- contr.treatment(2)
...
boxplot(DB$g_calc~DB$response_mode)
