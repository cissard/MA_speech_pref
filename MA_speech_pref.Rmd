...
full_model <- robu(g_calc ~ test_lang + vocal*agec, data=DB2, modelweights = "HIER", studynum = same_infant, var.eff.size = g_var_calc, small = T) 
...
full_model2 <- robu(g_calc ~ test_lang + natural*agec, data=DB2, modelweights = "HIER", studynum = same_infant, var.eff.size = g_var_calc, small = T) 

full_model2 <- robu(g_calc ~ test_lang*agec + natural*agec + vocal*agec + method, data=DB2, modelweights = "HIER", studynum = same_infant, var.eff.size = g_var_calc, small = T) 
