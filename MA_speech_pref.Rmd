...
#age
plot(unique(DB$mean_age_1)[1:33],g_age, main = 'ES as a function of age', xlab = 'age (days)', ylab = 'g_calc')
#naturalness
...
#full model
full_model <-rma.mv(g_calc, g_var_calc, mods=~ naturalness*agec, random = ~ 1 | study_ID/same_infant,data=DB, weighted=TRUE, method = "ML")
