...
table_stim=rbind(
 cbind( "Animal calls", "Band-pass-filtered speech"),
 cbind( "Heartbeat", "White noise")
)

row.names(table_stim)<-c("Vocal","Non-vocal")
colnames(table_stim)<-c("Natural","Artificial")

apa_table(table_stim,  align='cc',  caption = "Examples of stimuli classified into each competitor category.", escape= T)
```
