...
library(stringr)
library(purrr)
#library(langcog) #ac not needed? remove
library(grid)
library(gridExtra)
library(RCurl)
library(papaja)
...
#ac papers & temp needed in the text below, but not yet generated; making a fake one here just to be able to knit the code
papers=temp=NULL
