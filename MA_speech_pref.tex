...
\caption{\label{tab:Table1}Examples of stimuli classified into each competitor category.}

\begin{tabular}{ccc}
\toprule
 & \multicolumn{1}{c}{Natural} & \multicolumn{1}{c}{Artificial}\\
\midrule
Vocal & Animal calls & Band-pass-filtered speech\\
Non-vocal & Heartbeat & White noise\\
\bottomrule
\end{tabular}
