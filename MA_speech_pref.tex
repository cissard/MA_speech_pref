...
\abstract{
The human auditory system is amazingly efficient at processing speech, with a preference for these sounds reported by full term birth. Infants tested at a variety of ages have been presented with contrasts between native or foreign speech and another sound, which may be vocal or not, natural or not. These data constitute a rich pool of evidence that can be sourced from to assess how language, vocal quality, and naturalness affect speech preference across development. To shed light on whether some of these mechanisms may be at play, we conducted a meta-analysis of experiments testing speech preference in infants. Synthesizing data from 775 infants across 38 experiments, we found a medium effect size, with infants reliably preferring speech over other sounds. This preference was not significantly moderated by familiarity, vocal quality, or naturalness of the competitor. Strinkingly, we found no effect of age: infants showed the same strength of preference throughout the first year of life. Speech therefore appears to be preferred from birth, even to other natural or vocal sounds. These results nuance current views of the literature, and call for further investigation of the phenomenon.
